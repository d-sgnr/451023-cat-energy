...
ymaps.ready(function() {
  ...
  var myMap = new ymaps.Map('map', {
    ...
    myPlacemark = new ymaps.Placemark([59.938915, 30.323061],
      ...
      {
        balloonContentBody: "<div class='ballon-point'><div class='ballon-img'><img src='../img/map-pin.png/></div><div class='ballon-content'>Какой-нибудь текст, который откроется при клике на метку карты</div></div>"
      },
